...
import br.com.dio.java_bank.excetion.AccountWithInvestmentException;
import br.com.dio.java_bank.excetion.InvestmentNotFoundException;
import br.com.dio.java_bank.excetion.WalletNotFoundException;
import br.com.dio.java_bank.model.AccountWallet;
import br.com.dio.java_bank.model.InvestimentWallet;
import br.com.dio.java_bank.model.Investment;
...
public class InvestimentRepository {
    ...
    public Investment create(final long tax,  final long initialFunds){
        this.nestId ++;
        var investment = new Investment(this.nestId, tax, initialFunds);
